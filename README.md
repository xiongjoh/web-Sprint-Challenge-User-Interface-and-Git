...
align-items: center; works on the main axis

5. Explain why git is valuable to a team of developers.
git is valuable because it helps with version control, mistakes in code can be handled easier and
older versions can be recalled if there are issues in the future.
